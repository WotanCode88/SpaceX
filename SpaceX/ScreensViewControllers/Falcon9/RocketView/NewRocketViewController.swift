...
class NewRocketViewController: UIViewController {
    ...
    let falconSat = RocketInfoSquareView(title: "X",
                                         subtitle: "2 февраля, 2022",
                                         success: true)
    let heavyHolidays = RocketInfoSquareView(title: "X",
                                             subtitle: "6 января, 2022",
                                             success: true)
    let crs24 = RocketInfoSquareView(title: "X",
