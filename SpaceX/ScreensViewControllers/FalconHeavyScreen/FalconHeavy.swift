...
class FalconHeavy: UIViewController {
//MARK: - UI
...
//MARK: - viewDidLoad
   ...
   private func addTargets() {
    ...
    let horizontal = HorizontalInfoView(nameOfRocket: "Falcon Heavy")
    ...
    let allInfoView = BlockOfInfoView(nameOfRocket: "Falcon Heavy")
...
//MARK: - selectors
    ...
    @objc func rocketViewTapped() {
        let rocketVC = RocketViewController(rocket: "Falcon Heavy")
